...
<div class="pdf-table">
    <table>
            ...
            %for (dir_name, attachments) in elec_attachments.items():
                ...
                %for attachment in attachments:
                    <tr>
                        ...
                        <td class="table-content">${attachment.create_date and formatLang(attachment.create_date,date_time=True) or ''}</td>
        ...
        <tr>
            ...
            <td>签署日期：</td>
            <td colspan="2">${object.elec_file_approver_date and formatLang(object.elec_file_approver_date,date_time=True) or ''|entity}</td>
        </tr>
        </tbody>
    </table>
</div>
