-- users
SELECT 'USR_'+dbo.LZ_MISUser.SU_UserID AS 'External Id', 
      dbo.LZ_MISUser.SU_UserName AS name, dbo.LZ_MISUser.SU_LoginName AS login, 
      ~dbo.LZ_MISUser.SU_IsDel AS active,
      dbo.LZ_MisUserAddressBook.SU_EmpMobile AS Mobile, 
      dbo.LZ_MisUserAddressBook.SU_EmpComTel AS Phone, 
      dbo.LZ_MisUserAddressBook.SU_EmpEAddr AS Email, 
      replace(CONVERT(varchar, 
                  dbo.LZ_MISUserInfo.SU_Birthday, 111),'/','-') AS Birthdate, 
...
--employee with dep and pos. make sure to import pos and dep first!
SELECT 'USR_'+dbo.LZ_MISUser.SU_UserID AS 'User / External Id', 
      'EMP_'+dbo.LZ_MisUser.SU_UserID as 'External Id',
...
(SELECT TOP 10000 * FROM 
	(SELECT TOP 10000 dbo.Hp_Information.HI_ID AS [external id], 
		...
		SZGH_OA_20050823.dbo.p_systemuser_all.UserGrpID AS [department/external id], 
		...
		SZGH_OA_20050823.dbo.p_systemuser_all ON 
		dbo.Hp_Information.HU_UserID = SZGH_OA_20050823.dbo.p_systemuser_all.SU_UserID ORDER BY dbo.Hp_Information.HI_SetTime ASC
...
(SELECT TOP 10000 dbo.Hp_Information.HI_ID  
	...
	dbo.HP_Module ON dbo.Hp_Information.HM_ID = dbo.HP_Module.HM_ID INNER JOIN
	SZGH_OA_20050823.dbo.p_systemuser_all ON 
	dbo.Hp_Information.HU_UserID = SZGH_OA_20050823.dbo.p_systemuser_all.SU_UserID ORDER BY dbo.Hp_Information.HI_SetTime DESC
);
