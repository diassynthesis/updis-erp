...
SELECT 'USR_'+dbo.LZ_MISUser.SU_UserID AS 'User External Id', 
	...
	dbo.LZ_MISUserInfo.SU_Bio AS notes, 
      ...
      dbo.LZ_MISUserInfo.SU_BeginWorkDate AS [begin_work_date],
      dbo.LZ_MISUserInfo.SU_EnterDate AS [enter_date],
      dbo.LZ_MISUserInfo.SU_ContractDate AS [contract_date],
      dbo.LZ_MISUserInfo.SU_Speciality AS major,
      dbo.LZ_MISUserInfo.SU_AS major,
